...
export function Snake() {
    ...
    // const move = (dir) => {
    //     if (!paused) {
    //         if (dir === 'left' && prevDirection[0] !== 1 && prevDirection[1] !== 0) setDirection([-1, 0]);
    //         if (dir === 'up' && prevDirection[0] !== 0 && prevDirection[1] !== 1) setDirection([0, -1]);
    //         if (dir === 'right' && prevDirection[0] !== -1 && prevDirection[1] !== 0) setDirection([1, 0]);
    //         if (dir === 'down' && prevDirection[0] !== 0 && prevDirection[1] !== -1) setDirection([0, 1]);
    //         if (!speed) nudgeSnake();
    //     }
    // }
